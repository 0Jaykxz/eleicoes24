function calcularSoma() {
    ...
    const eris = parseFloat(document.getElementById('num10').value) || 0;
    const ceres = parseFloat(document.getElementById('num11').value) || 0;
    const makemake = parseFloat(document.getElementById('num12').value) || 0;
    const haumea = parseFloat(document.getElementById('num13').value) || 0;
    const charon = parseFloat(document.getElementById('num14').value) || 0;
    const somaPlanetas = mercurio + venus + terra + marte + jupiter + saturno + urano + netuno + plutao + eris + ceres + makemake + haumea + charon;
    ...
    localStorage.setItem('charon', charon);
...
function carregarValores() {
    ...
    const charon = localStorage.getItem('charon') || 0;
    ...
    document.getElementById('num10').value = eris;
    document.getElementById('num11').value = ceres;
    document.getElementById('num12').value = makemake;
    document.getElementById('num13').value = haumea;
    document.getElementById('num14').value = charon;
    document.getElementById('resultado').textContent = somaPlanetas;
}
...
const votoCharon = localStorage.getItem('charon');
...
document.getElementById('s9').textContent = votoEris;
document.getElementById('s1').textContent = votoCeres;
document.getElementById('s3').textContent = votoMakemake;
document.getElementById('s7').textContent = votoHaumea;
document.getElementById('s8').textContent = votoCharon;
